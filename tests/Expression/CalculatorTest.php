...
use Platine\Workflow\Expression\Calculator;
use Platine\Workflow\Expression\CustomFunction;
use Platine\Workflow\Expression\Exception\IncorrectExpressionException;
use Platine\Workflow\Expression\Exception\UnknownFunctionException;
use Platine\Workflow\Expression\Exception\UnknownOperatorException;
use Platine\Workflow\Expression\Exception\UnknownVariableException;
